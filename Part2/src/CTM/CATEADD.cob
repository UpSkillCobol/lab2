      ...
      ******************************************************************
       01 ADD-CATEGORY-SCREEN
           ...
           05 REG-CATE-ID PIC 9(003) LINE 09 COL 25 USING WSCATEGORY-ID.
           05 REGISTER-RECORD.
      ...
      ******************************************************************
       ...
       115-GET-NAME SECTION.
           ...
           DISPLAY INSTRUCTIONS-ZONE ACCEPT REG-CATE-NAME
       ...
       120-GET-DESCRIPTION SECTION.
           ...
           DISPLAY INSTRUCTIONS-TEXT ACCEPT REG-CATE-DESCRIPTION
