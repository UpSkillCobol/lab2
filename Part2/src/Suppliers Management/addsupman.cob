      ...
      ******************************************************************
       01 MANUALLY-ADD-SUPPLIER-SCREEN
           ...
           05 REG-SUPP-ID PIC 9(003) LINE 08 COL 39 USING WSSUPPLIER-ID.
           05 REGISTER-RECORD.
      ...
      ******************************************************************
       ...
       115-GET-NAME SECTION.
           ...
           DISPLAY INSTRUCTIONS-ZONE ACCEPT REG-SUPP-NAME
      ...
      *     CALL "RMVEXTSPACES" USING BY REFERENCE WSSUPPLIER-NAME
       ...
       120-GET-DESCRIPTION SECTION.
           ...
           DISPLAY INSTRUCTIONS-TEXT ACCEPT REG-SUPP-DESCRIPTION
      ...
      *     WSSUPPLIER-DESCRIPTION3
       ...
       125-GET-ADDRESS SECTION.
           ...
           DISPLAY INSTRUCTIONS-ZONE ACCEPT REG-SUPP-ADDRESS
           CALL "LOWERUPPER" USING BY REFERENCE WSSUPP-ADR-MAIN1
      *     CALL "LOWERUPPER" USING BY REFERENCE WSSUPP-ADR-MAIN2
      *     CALL "RMVEXTSPACES" USING BY REFERENCE WSSUPP-ADR-MAIN1
      *     CALL "RMVEXTSPACES" USING BY REFERENCE WSSUPP-ADR-MAIN2
       EXIT SECTION.
       ...
       130-GET-POSTAL-CODE SECTION.
           PERFORM WITH TEST AFTER UNTIL VALID-POSTAL-CODE
               ...
               DISPLAY INSTRUCTIONS-ZONE ACCEPT REG-SUPP-POSTAL-CODE
       ...
       135-GET-TOWN SECTION.
           PERFORM WITH TEST AFTER UNTIL WSSUPPLIER-TOWN IS ALPHABETIC
               ...
               DISPLAY INSTRUCTIONS-ZONE ACCEPT REG-SUPP-TOWN
      ...
      *            CALL "RMVEXTSPACES" USING BY REFERENCE WSSUPPLIER-TOWN
       ...
       145-GET-PHONE SECTION.
           ...
           AND VALID-PHONE3
               ...
               DISPLAY INSTRUCTIONS-ZONE ACCEPT REG-SUPP-PHONE
