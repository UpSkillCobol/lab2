      ...
      ******************************************************************
       01 UPDATE-RECORD.
           05 EDIT-RECORD.
               10 EDIT-INGREDS-NAME PIC X(030) LINE 09 COL 29
                   TO WSINGREDS-NAME REQUIRED.
               10 EDIT-INGREDS-DESCRIPTION.
                   15 EDIT-INGRED-DESCRIPTION PIC X(050) LINE 10 COL 29
      ...
      ******************************************************************
       ...
       155-GET-DESCRIPTION SECTION.
           ...
           CALL "LOWERUPPER" USING BY REFERENCE WSINGREDS-DESCRIPTION
