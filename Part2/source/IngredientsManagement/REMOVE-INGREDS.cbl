      ...
      ******************************************************************
       ...
       FILE-CONTROL.
               SELECT FXINGRED ASSIGN TO "FXINGREDS"
                   ...
                   ALTERNATE KEY IS DEL-INGREDS-NAME WITH DUPLICATES
       ...
       01  DELETE-INGREDIENT                       PIC X(002).
           88 DELETE-INGRED-VALID                VALUE "Y" "y" "N" "n".
       77  DUMMY                               PIC X(001).
